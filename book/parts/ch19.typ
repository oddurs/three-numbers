...
#lead[
  The model this book has built is powerful and finite, and the honest close is to say
  where it stops. Not as an apology --- the model earns its keep on every page before
  this one --- but because a reader who knows its boundary can tell the difference
  between a question it answers badly and a question it does not answer at all.
]
