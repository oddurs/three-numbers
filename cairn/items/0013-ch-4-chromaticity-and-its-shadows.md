---
id: 13
title: Ch 4 — Chromaticity and Its Shadows
type: chapter
status: backlog
milestone: v0.4
depends_on:
...
**The argument.** Normalise away intensity and two dimensions remain. The resulting diagram is the most recognisable image in the field and the most abused: it is a projective picture, distances in it mean nothing, and the areas people compare on it are not the quantities they think they are comparing.

5 sections · 6,500 planned words · part II
Outline: `outline/ch04.outline.ts`

**Figures.** `cie-1931-chromaticity`, `blackbody-spectra`

**Sources.** `cie-15-colorimetry`, `macadam-1942-visual`
