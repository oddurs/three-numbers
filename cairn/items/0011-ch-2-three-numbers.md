...
**The argument.** This is the pivot of Part I. Three cone types, three inner products, one 3-vector. From that single fact derive Grassmann's laws, the existence of metamers, and the reason colour arithmetic is linear at all --- which is the property that makes every matrix in the rest of the book legitimate.

5 sections · 6,500 planned words · part I
Outline: `outline/ch02.outline.ts`

**Figures.** `metamer-pair`

**Sources.** `cie-15-colorimetry`, `cvrl-database`, `stockman-2000-spectral`, `wyszecki-stiles`
