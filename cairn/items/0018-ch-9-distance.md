...
**The argument.** How different are two colours? The question sounds simple and has consumed seventy years of committee work. Follow the sequence from Euclidean distance to CIEDE2000 as a series of empirical failures and patches, then ask what Oklab's claim to need no patches actually amounts to.

5 sections · 7,100 planned words · part III
Outline: `outline/ch09.outline.ts`

**Figures.** `delta-e-contours`

**Sources.** `cie-15-colorimetry`, `itu-bt2100`, `macadam-1942-visual`, `ottosson-oklab`, `sharma-2004-ciede2000`
