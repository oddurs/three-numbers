---
id: 21
title: Ch 12 — Quantisation and Banding
type: chapter
status: backlog
milestone: v0.6
depends_on:
...
**The argument.** Banding is a quantisation artefact, and like all quantisation artefacts it is best understood as a signal-processing problem: a smooth signal, a coarse quantiser, and a viewer whose visual system happens to amplify exactly the kind of error a naive quantiser produces.

4 sections · 5,100 planned words · part IV
Outline: `outline/ch12.outline.ts`

**Figures.** `dither-methods`

**Sources.** `itu-bt2100`, `poynton-video`, `ulichney-1993-void`
