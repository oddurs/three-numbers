---
id: 12
title: Ch 3 — The Standard Observer
type: chapter
status: backlog
milestone: v0.3
depends_on:
...
**The argument.** The CIE 1931 observer is the most consequential set of three curves in engineering, and it is usually presented as a measurement. It is not: it is a measurement followed by a change of basis chosen for convenience, and both halves matter.

5 sections · 6,700 planned words · part I
Outline: `outline/ch03.outline.ts`

**Figures.** `colour-matching-functions`

**Sources.** `cie-15-colorimetry`, `cvrl-database`, `wyszecki-stiles`
