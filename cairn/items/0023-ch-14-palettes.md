...
**The argument.** Two questions that look alike. Reducing an image to k colours is clustering, and the answer depends entirely on the metric. Designing k colours that a reader can tell apart is sphere packing under a perceptual metric with constraints, and the constraints are where the interesting work is.

5 sections · 6,800 planned words · part IV
Outline: `outline/ch14.outline.ts`

**Figures.** `cvd-simulation`

**Sources.** `brettel-1997-computerized`, `heckbert-1982-color`, `moreland-diverging`, `ottosson-oklab`
